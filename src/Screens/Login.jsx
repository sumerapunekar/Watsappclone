...
function Login(props) {
  ...
  return (
    <div className='max-w-7xl mx-auto my-2 flex flex-col-1 justify-center items-center bg-gradient-to-br from-yellow-400 via-red-500 to-purple-400 rounded-md h-screen '>
      <div className='bg-white rounded-md shadow-2xl shadow-rose-400 px-8 py-4 h-96 space-y-4 text-2xl font-bold'>
       ...
       Phone Number : <input  name="mobile" placeholder='Enter Number' type='tel' className='items-center text-base font-semibold rounded-md px-2 border-2 border-gray-200'/><br/>
       <button  className='bg-orange-400 text-white items-center rounded-full text-sm w-28 px-2 py-2 ml-32'>Enter</button><br/>
       OTP : <input  placeholder='Enter OTP' type='text' className='items-center text-base font-semibold rounded-md px-2 border-2 border-gray-200'/><br/>
       ...
       <button  className='rounded-full w-28 bg-orange-400 text-white items-center text-sm ml-32 px-2 py-2'>SignUp</button><br/>
       </div>
      </div>
       </div>
